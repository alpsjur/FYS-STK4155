...
\begin{figure}[htbp]
	...
	\caption{MSE for the Ridge regression method on the reduced terrain data set. The MSE decreases as the degree increases. The minimum MSE decreases as $\lambda$ decreases.}
...
\begin{figure}[htbp]
	...
	\caption{MSE for the Lasso regression method on the reduced terrain data set. The MSE decreases as the degree increases. The minimum MSE decreases as $\lambda$ decreases.}
