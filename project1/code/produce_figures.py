...
min_RIDGE = plf.plot_test_vs_degree_multiple_lambda(ax4, x, y, z, reg, max_degree, hyperparams)
...
min_LASSO = plf.plot_test_vs_degree_multiple_lambda(ax6, x, y, z, reg, max_degree, hyperparams)
